...
export class SalesBillOfMaterialComponent implements OnInit {
  ...
  bomCondition: string =
    "BM_I_CODE=I_CODE AND BOM_MASTER.ES_DELETE=0 AND ITEM_MASTER.ES_DELETE=0";
  ...
  ngOnInit(): void {
    ...
    this.commonService
      .getTableResponse(
        "I_CODE,I_UOM_NAME,I_CODENO,I_NAME",
        "ITEM_UNIT_MASTER,ITEM_MASTER",
        "ITEM_MASTER.I_UOM_CODE=ITEM_UNIT_MASTER.I_UOM_CODE AND ITEM_MASTER.ES_DELETE=0 AND ITEM_UNIT_MASTER.ES_DELETE=0"
      )
      .subscribe((data) => {
        ...
        for (let items of this.itemTableResponse) {
          ...
          this.I_UOM_NAME.push({
            label: items.I_UOM_NAME,
            value: items.I_CODE,
          });
        }
      });
  ...
  //   this.router.navigate(["sales/transaction/invoice"], {
  //     queryParams: { bm_code: bm_code, pg: pg },
  //   });
  // }
  ...
  //     accept: () => {
  //       this.service
  //         .deleteTable("BOM_MASTER", "BM_CODE=" + bm_code)
  //         .subscribe((data) => {
  //           this.service
  //             .deleteTable("BOM_DETAIL", "BD_BM_CODE=" + bm_code)
  //             .subscribe((data2) => {
  ...
  //     return;
  //   } else if (
  //     !this.material_table.some(
  //       (item) => item.MAT_I_CODE == this.m["I_CODENO"].value
  //     )
  //   ) {
  //     let mat_table = this.getItemTableRow(this.m["I_CODENO"].value);
  //     console.log(mat_table);
  //     this.material_table.push({
  //       id: this.material_table.length + 1,
  //       MAT_I_CODE: this.m["I_CODENO"].value,
  //       MAT_I_CODENO: mat_table.I_CODENO,
  //       MAT_I_NAME: mat_table.I_NAME,
  //       MAT_I_UOM_NAME: mat_table.I_UOM_NAME,
  //       SQTY: this.m["SQTY"].value,
  //       VQTY: this.m["VQTY"].value,
  //     });
  //     this.messageService.add({
  //       key: "t2",
  //       severity: "success",
  //       summary: "success",
  //       detail: "Material Added to the table",
  //     });
  ...
  //       detail: "Selected Material already added",
  //     });
  //     return;
  //   }
  // }
  ...
  //   if (
  //     material_table.MAT_I_CODE ==
  //     this.clonedProducts[material_table.id].MAT_I_CODE
  //   ) {
  //     this.material_table[index] = {
  //       id: material_table.id,
  //       MAT_I_CODE: mat_table.I_CODE,
  //       MAT_I_NAME: mat_table.I_NAME,
  //       SQTY: material_table.SQTY,
  //       MAT_I_UOM_NAME: mat_table.I_UOM_NAME,
  //       VQTY: material_table.VQTY,
  //       MAT_I_CODENO: mat_table.I_CODENO,
  //     };
  //   } else {
  //     this.material_table[index] = {
  ...
  //     severity: "success",
  //     summary: "Success",
  //     detail: "Raw Material   is updated",
  //   });
  // }
  ...
  //   this.service
  //     .getBomDetailTable(bomTable.BM_CODE)
  //     .subscribe((data) => {
  ...
  //         this.material_table.push({
  //           id: this.material_table.length + 1,
  //           MAT_I_CODENO: bomDetailTable.I_CODENO,
  //           MAT_I_NAME: bomDetailTable.I_NAME,
  //           SQTY: detail.BD_SCRAPQTY,
  //           MAT_I_UOM_NAME: bomDetailTable.I_UOM_NAME,
  //           VQTY: detail.BD_VQTY,
  //           MAT_I_CODE: detail.BD_I_CODE,
  //         });
  //       }
  //     });
  //   this.displayBasic = true;
